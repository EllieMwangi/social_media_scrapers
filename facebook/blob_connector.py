...
class AzureBlobStorage:
    ...
    def get_latest_file(self):
        ...
        self.container_client = self.blob_service_client.get_container_client(container = 'facebook-inputs')
    ...
    def upload_file(self, filename):
        ...
        blob_client = self.blob_service_client.get_blob_client(container='facebook-outputs', blob=filename.split('/')[1])
